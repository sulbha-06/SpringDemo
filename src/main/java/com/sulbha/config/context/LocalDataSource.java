...
import static com.sulbha.utility.contants.AppConstants.REPO_PACKAGES_TO_SCAN;
...
public class LocalDataSource {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource)throws Exception{
		...
		entityManagerFactory.setPackagesToScan(EmployeeTransaction.class.getPackage().getName());
